...
from test_sdk_filter_contigs_nt.test_sdk_filter_contigs_ntImpl import test_sdk_filter_contigs_nt
from test_sdk_filter_contigs_nt.test_sdk_filter_contigs_ntServer import MethodContext

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class test_sdk_filter_contigs_ntTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'test_sdk_filter_contigs_nt',
        ...
        for nameval in config.items('test_sdk_filter_contigs_nt'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL)
        cls.serviceImpl = test_sdk_filter_contigs_nt(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_test_sdk_filter_contigs_nt_" + str(suffix)
